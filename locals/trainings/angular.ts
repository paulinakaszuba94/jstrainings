export const angular = {
    ...
    "name": "Angular",
    "en": {},
    "mainDescription": " Angular to nowoczesny framework pozwalający na tworzenie skalowalnych aplikacji" +
        " frontendowych. Razem z RxJS oraz TypeScriptem tworzy bardzo potężny i złożony zestaw narzędzi. Dokładne" +
        " zrozumienie mechaniki Angulara pozwala wykorzystać w 100% jego możliwości, tak aby tworzyć wydajne" +
        " aplikacje o przejrzystej strukturze i proste w dalszym rozwoju.",
    "alt": "Angular",
    "img": "./img/portfolio/thumbnails/angular.png",
    "src": ".././img/portfolio/thumbnails/angular.png",
    "href": "details/angular.html"
};
