...
exports.testing = {
    "id": "testing",
    "list": ["Jak pisać testowalny kod", "Różne typy testów - unit tests, integration test, regression tests, acceptance tests",
        "Różnica w podejściach typu TDD oraz BDD", "Różnice między frameworkami do testowania - Jasmine, Jest, Protractor, Cucumber",
        "Zasada Arrange-Act-Assert", "Tworzenie testów w Jasmine", "Tworzenie suite’s za pomocą describe i it",
        " Używanie wbudowanych matcher’ów i asymetrychnych matcher’ów", "Negacje matcher’ów", "Arrange-Act-Assert w" +
            " Jasmine",
        "Słowo kluczowe this w suite", "Ręczne wywoływanie niepowodzeń", "Disabled suites", "Pending suites", "Function spies",
        "Mockowanie funkcji", "Mockowanie czasu i daty", "Testowanie asynchronicznego kodu za pomocą callbacków," +
            " promisów, async/await",
        "Mckowanie wywołań eventów", "Mockowanie odpowiedzi z serwera", "Custom matchers", "Custom equality",
        "Custom asymmetric equality", "Inne narzędzia jasmine (reporters, custom boot)",
    ...
    "alt": "Testy Automatyczne",
    "img": "./img/portfolio/thumbnails/testing.png",
    "src": ".././img/portfolio/thumbnails/testing.png",
    "href": "details/testing.html"
};
