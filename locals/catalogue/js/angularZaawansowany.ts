...
Szkolenie adresowane jest do programistów znających podstawy frameworka Angular.`,
    ...
    list: [
        ...
        `Tworzenie bardziej skomplikowanych dyrektyw`,
        `Element Host`,
        ...
        `Routing guards`,
        `Animacje`,
        `Dzielenie angularowej aplikacji na moduły`,
        `Incremental DOM`,
        `Reaktywne komponenty`,
        `Strategie change detection w szczegółach`,
        `Performance`,
        `AiT i JiT`,
        `End-to-end tests`,
        `Angular Material Design`,
        `Implementacja wzorców architektonicznych w angularze`,
        `MV* (MVC, MVVM, MVP)`,
        `Model-View-Intent`],
