...
Szkolenie adresowane jest do programistów znających język Java.`,
    duration:
        3,
    list: [
        `Porównanie podejścia OOP i podejść wykorzystywancyh w JS`,
        `Porównanie narzędzi Javowych i JavaScriptowych`,
        `Jak nie popełniać typowych błędów ludzi ze świata OOP`,
        `W jaki sposób wykorzystywać elastyczność języka JavaScript`,
        `Wstęp do TypeScript`,
        `Mechanika JS w szczegółach`,
        `Kilka słów nt. node`,
        `Kilka słów nt. JSowych biliotek i frameworków (Angular, Vue, React)`],
