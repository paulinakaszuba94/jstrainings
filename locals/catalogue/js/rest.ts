...
`,
    duration:
        1,
    list: [
        `Przegląd wzorców architektonicznych`, `Protokół HTTP`,`Stanowość i bezstanowość`,`Komunikacja klient-serwer`,`Autoryzacja`,`Implementacje REST w różnych językach programowania`],
