...
Szkolenie adresowane jest do programistów znających język JavaScript, chcących się nauczyć Reacta od podstaw.`,
    ...
    skills: `
Po ukończonym szkoleniu uczestnicy będą znać zasady działania biblioteki React i będą wiedzieć, jak użyć tej biblioteki razem z menadżerami stanów, takimi jak Redux, MobX czy React hooks. Ponadto zdobędą informacje na temat dobrych praktyk, podejścia funkcyjnego oraz tworzenia przejrzystych struktur aplikacji reactowych.
`
