export const howItWorks = {
    ...
    examples: {
        description: 'Szkolenia skupiają się wokół czysto praktycznej wiedzy. Technologie są omawiane na realnych przykładach i problemach, z którymi każdy programista może się spotkać w czasie pracy zawodowej.',
        name: 'Przykłady z życia wzięte'
    },
    exercises: {
